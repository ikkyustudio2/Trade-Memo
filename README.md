...
**ข่าวที่มีผลต่อทองคำ** — หน้าไดอารี่แสดงข่าว USD ที่มีผล impact สูง/กลาง (Retail Sales, CPI, FOMC ฯลฯ) ของวันนั้นให้อัตโนมัติ ดึงจาก economic calendar ของ ForexFactory ผ่าน GitHub Action ที่รันทุก 6 ชั่วโมง (ดึงตรงจากเบราว์เซอร์ไม่ได้เพราะติด CORS) เก็บไว้ที่ `data/calendar.json` ครอบคลุมช่วง ~1 สัปดาห์ปัจจุบัน
